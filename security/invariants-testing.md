...
- **Handler functions**: buy, refund, refundTo, deposit, redeem, transfer, setup calls
...
| `invariant_operations_fee_gets_dmfUSD_not_USDC` | 1,000,000 | 20 | ✅ PASS | No USDC transfer path to Operations recipients |
...
- Buy -> transfer -> refundTo -> deposit -> buy -> refund -> redeem -> transfer -> setup calls
- Fee cap boundary at exactly $20 and above
- Zero amounts, maximum amounts, and everything in between
- privileged vs non-privileged callers
...
| `testFuzz_buy_operationsFeeGetsDmfUsd` | 10,000,000 | ✅ PASS |
| `testFuzz_privilegedRoute_matchesPublicBuy` | 10,000,000 | ✅ PASS |
...
| `testFuzz_nonPrivilegedCannotCallRoute` | 10,000,000 | ✅ PASS |
...
| `testFuzz_routeRevertsZeroBuyer` | 10,000,000 | ✅ PASS |
| `testFuzz_routeRevertsZeroAmount` | 10,000,000 | ✅ PASS |
